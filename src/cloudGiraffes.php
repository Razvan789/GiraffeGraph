...
<html>
	...
	<body>
		...
		<div class="main-body">
			<div id="cloudDocumentOptions" class="document-opener">
				<table style="width:100%; text-align: center;">
					<tr>
						...
						<td>
							<h2 colspan="2">Last Accessed</h2>
						</td>
					</tr>
					<tr>
						<td style="padding:25px;">
							<img src ="../assets/CloudGiraffesSymbol.png" alt = "Cloud Documents" style="height: 70px">
						</td>
						<td colspan="2" style="padding:25px;">
							<p>Lorem Ipsum</p>
						</td>
